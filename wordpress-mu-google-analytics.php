...
function google_analytics_output() {
	...
	if ( !empty( $google_analytics_site_tracking_code ) || !empty( $google_analytics_blog_tracking_code ) ) {
		...
		?>
		var pageTracker = _gat._getTracker("<?php echo $google_analytics_site_tracking_code; ?>");
		...
		?>
		var pageTracker2 = _gat._getTracker("<?php echo $google_analytics_blog_tracking_code; ?>");
